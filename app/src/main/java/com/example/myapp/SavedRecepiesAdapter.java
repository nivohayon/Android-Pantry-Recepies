...
public class SavedRecepiesAdapter extends ArrayAdapter<RecepieDetails> {
    FirebaseAuth mAuth;
    ...
    public SavedRecepiesAdapter(@NonNull Context context, int resource, ArrayList<RecepieDetails> recepiesList, ArrayList<String> savedRecepies) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        SaveSwitch.getBackground().setColorFilter(mContext.getResources().getColor(R.color.red), PorterDuff.Mode.SRC_ATOP);
