...
public class AddRecepieAdapter extends ArrayAdapter<Ingredient> {
    FirebaseAuth mAuth;
    ...
    public AddRecepieAdapter(@NonNull Context context, int resource, ArrayList<Ingredient> arrayList, ArrayList<String> savedIngredients) {
        ...
        ingredientName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cb.isChecked()) {
                    ...
                    myRef.child("temp").push().setValue(cb.getText().toString());
                } else {
                    savedIngredients.remove(cb.getText().toString());
                    Query applesQuery = myRef.child("temp").orderByValue().equalTo(cb.getText().toString());
